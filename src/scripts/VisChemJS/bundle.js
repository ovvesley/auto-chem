/******/ (function(modules) {
  ...
  /******/ [
    ...
    /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__atom__ = __webpack_require__(
        1
      );
      ...
      function drawBenzene(position) {
        ...
        for (let i = 1; i <= numberOfSides; i += 1) {
          ...
          let ring1 = new __WEBPACK_IMPORTED_MODULE_0__atom__[
            "a" /* default */
          ]("C", 1, 0, {
      ...
      function makeAtom(position) {
        ...
        if (bondType === "single") {
          atom = new __WEBPACK_IMPORTED_MODULE_0__atom__["a" /* default */](
            "C",
            4,
            0,
            position
      ...
      function makeCarbon(position) {
        let atom = new __WEBPACK_IMPORTED_MODULE_0__atom__["a" /* default */](
          "C",
          4,
          0,
          position
      ...
      function isAtomAtPos(pos) {
        for (let i = 0; i < positionsArray().length; i++) {
          if (
            pos.x <= positionsArray()[i].x + 25 &&
            pos.x >= positionsArray()[i].x - 25 &&
            (pos.y <= positionsArray()[i].y + 25 &&
              pos.y >= positionsArray()[i].y - 25)
          ) {
            console.log("made it");
      ...
      function init() {
        ...
        document
          .getElementById("primaryAmine")
          .addEventListener("click", function() {
            bondType = "primaryAmine";
          });

        document
          .getElementById("secondaryAmine")
          .addEventListener("click", function() {
            bondType = "secondaryAmine";
          });

        document
          .getElementById("tertiaryAmine")
          .addEventListener("click", function() {
        ...
        document
          .getElementById("bromine")
          .addEventListener("click", function() {
            bondType = "bromine";
          });

        document
          .getElementById("chlorine")
          .addEventListener("click", function() {
            bondType = "chlorine";
          });

        document
          .getElementById("fluorine")
          .addEventListener("click", function() {
            bondType = "fluorine";
          });

        document
          .getElementById("cyclohexane")
          .addEventListener("click", function() {
            bondType = "cyclohexane";
          });
        document
          .getElementById("cyclobutane")
          .addEventListener("click", function() {
