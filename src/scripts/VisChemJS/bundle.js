...
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    for (let i = 1; i <= numberOfSides;i += 1) {
      ...
      let ring1 = new __WEBPACK_IMPORTED_MODULE_0__atom__["a" /* default */]('C', 1, 0, {x: (Xcenter + size * Math.cos(i * 2 * Math.PI / numberOfSides)), y: (Ycenter + size * Math.sin(i * 2 * Math.PI / numberOfSides)) });
    ...
    for (var i = 1; i <= numberOfSides;i += 1) {
      ...
      let ring1 = new __WEBPACK_IMPORTED_MODULE_0__atom__["a" /* default */]('C', 2, 0, {x: (Xcenter + size * Math.cos(i * 2 * Math.PI / numberOfSides)), y: (Ycenter + size * Math.sin(i * 2 * Math.PI / numberOfSides)) });
    ...
    function makeAtom(position) {
      ...
      if (bondType === "single") {
          atom = new __WEBPACK_IMPORTED_MODULE_0__atom__["a" /* default */]('C', 4, 0, position);
      }
      ...
      if (bondType === 'ketone') {
        atom = new __WEBPACK_IMPORTED_MODULE_0__atom__["a" /* default */]('O', 1, 0, position);
      }
    
      if (bondType === 'primaryAmine') {
        atom = new __WEBPACK_IMPORTED_MODULE_0__atom__["a" /* default */]('N', 1, 0, position);
      }
    
      if (bondType === 'secondaryAmine') {
        atom = new __WEBPACK_IMPORTED_MODULE_0__atom__["a" /* default */]('N', 2, 0, position);
      }
    
      if (bondType === 'tertiaryAmine') {
        atom = new __WEBPACK_IMPORTED_MODULE_0__atom__["a" /* default */]('N', 3, 0, position);
      }
      ...
      if (bondType === 'bromine') {
        atom = new __WEBPACK_IMPORTED_MODULE_0__atom__["a" /* default */]('Br', 1, 0, position);
      }
    
      if (bondType === 'chlorine') {
        atom = new __WEBPACK_IMPORTED_MODULE_0__atom__["a" /* default */]('Cl', 1, 0, position);
      }
    
      if (bondType === 'fluorine') {
        atom = new __WEBPACK_IMPORTED_MODULE_0__atom__["a" /* default */]('F', 1, 0, position);
      }
      ...
      if (bondType === 'imine') {
        atom = new __WEBPACK_IMPORTED_MODULE_0__atom__["a" /* default */]('NH', 1, 0, position);
      }
